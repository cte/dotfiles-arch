...
ln -sfn "${REPO}/.local/share/applications/btop.desktop" "${HOME}/.local/share/applications/btop.desktop"
...
ln -sfn "${REPO}/.local/share/applications/spotify-launcher.desktop" "${HOME}/.local/share/applications/spotify-launcher.desktop"
...
rm -f "${HOME}/.config/hypr/mocha.conf"
...
ln -sfn "${REPO}/.config/hypr/mocha.conf" "${HOME}/.config/hypr/mocha.conf"
...
ln -sfn "${REPO}/.config/hypr/restart-waybar.sh" "${HOME}/.config/hypr/restart-waybar.sh"
ln -sfn "${REPO}/.config/hypr/start-hypridle.sh" "${HOME}/.config/hypr/start-hypridle.sh"
...
ln -sfn "${REPO}/.config/hypr/start-camera-tweaks.sh" "${HOME}/.config/hypr/start-camera-tweaks.sh"
